...
def main():
    ...
    #----------------------------------------------------------
    # Import the correct dataset depending on whether
    # we are doing 1-channel or 3-channel image data
    #----------------------------------------------------------
    ...
    #----------------------------------------------------------    
    train_dataset = dataset(train_config, model_config['image_shape'],
                            model_config['block_size'],
                            train_config['train_data_path'], 
                            regularize=train_config['sequence_regularize'])

    val_dataset = dataset(train_config, model_config['image_shape'],
                          model_config['block_size'],
