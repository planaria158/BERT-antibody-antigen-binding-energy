...
#----------------------------------------------------------------------
# This file is for running inference on the Dense MLP model with the scFv dataset
#----------------------------------------------------------------------
def train(args):

    # Read the config
    config_path = './config/dense_mlp_params.yaml'  
    ...
    model = DenseMLP_Lightning.load_from_checkpoint(checkpoint_path=config['checkpoint_name'],config=config)
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Arguments for dense_mlp_model')
    parser.add_argument('--config', dest='config_path',
                        default='config/dense mlp_params.yaml', type=str)
